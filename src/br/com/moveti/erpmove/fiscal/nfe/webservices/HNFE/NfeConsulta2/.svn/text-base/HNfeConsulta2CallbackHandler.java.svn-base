 ...
 */
public abstract class HNfeConsulta2CallbackHandler {
     ...
     */
    public HNfeConsulta2CallbackHandler(Object clientData) {
     ...
     */
    public HNfeConsulta2CallbackHandler() {
    ...
    public void receiveResultnfeConsultaNF2(
            br.com.moveti.erpmove.fiscal.nfe.webservices.HNFE.NfeConsulta2.HNfeConsulta2Stub.NfeConsultaNF2Result result) {
    }
