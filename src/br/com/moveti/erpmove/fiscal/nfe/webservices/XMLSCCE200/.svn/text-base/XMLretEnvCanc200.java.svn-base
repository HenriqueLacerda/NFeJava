 ...
 */
package br.com.moveti.erpmove.fiscal.nfe.webservices.XMLSCCE200;
...
public class XMLretEnvCanc200 {
    ...
    public void BuscaDadosXML() {
        ...
        retEnviCCe = (retEnviCCe) xstream.fromXML(XML);
    }   
    class retEnviCCe {
    ...
    public String get_CStat() {
     ...
     public String get_nProt() {
      ...
      public String get_dhRegEvento() {
        return retEnviCCe.getRetEvento().getInfEvento().dhRegEvento;
    }
       public String get_xEvento() {
        return retEnviCCe.getRetEvento().getInfEvento().xEvento;
    }
}
