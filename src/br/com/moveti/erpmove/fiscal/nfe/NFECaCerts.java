...
public class NFECaCerts {
    ...
    private static final String JSSECACERTS = "C://PROJETO//NFeCacertsss";  
    ...
    public static void main(String[] args) {  
        try {  
            ...
            if (file.isFile() == false) {  
                ...
                File dir = new File("" + SEP + "lib" + SEP + "security");  
...
//            get("bhisshomologa.pbh.gov.br", 443, ks);  
//            get("bhissdigital.pbh.gov.br", 443, ks);  
            
            //get("teste.contagem.mg.gov.br", 443, ks);  
            get("nfse.contagem.mg.gov.br", 80, ks);
