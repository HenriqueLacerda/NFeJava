 ...
 */
public abstract class HNfeRecepcaoEventos2CallbackHandler {
     ...
     */
    public HNfeRecepcaoEventos2CallbackHandler(Object clientData) {
     ...
     */
    public HNfeRecepcaoEventos2CallbackHandler() {
    ...
    public void receiveResultnfeRecepcaoLote2(
            br.com.moveti.erpmove.fiscal.nfe.webservices.HNFE.NfeRecepcaoEventos2.HNfeRecepcaoEventos2Stub.NfeRecepcaoEventosLote2Result result) {
    }
